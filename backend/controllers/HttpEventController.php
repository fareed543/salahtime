        ...
        if ($user) {
            ...
            if ($headers->has('Authorization')) {
                ...
                if ($user) {
                    ...
                    $member->firstname = $data['firstname'] ?? null;
                    $member->lastname = $data['lastname'] ?? null;
                    $member->phone_number = $data['phone_number'] ?? null;
                    $member->email = $data['email'] ?? null;
                    $member->birthday = $data['birthday'] ?? null;
                    $member->address = $data['address'] ?? null;
                    $member->notes = $data['notes'] ?? null;
                    $member->photo = $data['photo'] ?? null;
                    $member->halka = $data['halka'] ?? null;
                    $member->masjid = $data['masjid'] ?? null;
