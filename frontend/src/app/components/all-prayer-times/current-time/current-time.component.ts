...
@Component({
  selector: 'app-all-prayer-times-current-time',
  templateUrl: './current-time.component.html',
  styleUrls: ['./current-time.component.scss']
})
export class AllPrayerTimesCurrentTimeComponent implements OnInit, OnDestroy {
  ...
  private getCurrentSalah(salahTimes: Record<SalahKey, SalahTime>): {
    key: SalahKey | null;
    start: Date | null;
    end: Date | null;
    index: number;
